...
class Score extends Base_Score {
 public static function get_records_by_uid_and_page_num($uid, $where = '1', $page_num = 1, $order_by = 'date_created', $direction = 'ASC') {
     ...
     * @param int $change     can be negative
    ...
    public static function new_record($uid=0, $item_type=1, $item_id=0, 
            ...
            $old_score=0, $change=0, $new_score=0, $status=parent::S_ACTIVE)
    {
        $arr = array('uid'=>$uid, 'item_type'=>$item_type, 'item_id'=>$item_id,
            'claim_id'=>$claim_id, 'type'=>$type,'description'=>$description,
            'old_score'=>$old_score, 'change'=>$change, 'new_score'=>$new_score,
            'status'=>$status,
        );
     ...
     * @param int $change
     */
    public static function create_question($uid, $qid, $old_score, $change)
    {
        ...
        self::new_record($uid, $item_type, $qid, $claim_id, $type, 
                $description, $old_score, $change, $new_score);
    }
    /**
     * 
     * @param int $uid
     ...
     * @param int $change
     */
    public static function create_answer($uid, $aid, $old_score, $change)
    {
        $item_type = 2;//answer 
        $claim_id = 0;
     ...
     * @param int $change
     */
    public static function create_ad($uid, $ad_id, $old_score, $change)
    {
        $item_type = 3;//ad 
        $claim_id = 0;
     ...
     * @param int $change
     */
    public static function correct_claim_question($uid, $qid, $claim_id, $old_score, $change)
    {
        $item_type = 1;//question 
     ...
     * @param int $change
     */
    public static function correct_claim_answer($uid, $aid, $claim_id, $old_score, $change)
    {
     ...
     * @param int $change
     */
    public static function correct_claim_ad($uid, $ad_id, $claim_id, $old_score, $change)
    {
     ...
     * @param int $change
     */
    public static function disable_question($uid, $qid, $claim_id, $old_score, $change)
    {
        $item_type = 1;//question 
     ...
     * @param int $change
     */
    public static function disable_answer($uid, $aid, $claim_id, $old_score, $change)
    {
        $item_type = 2;//answer 
        $claim_id = 0;
     ...
     * @param int $change
     */
    public static function disable_ad($uid, $ad_id, $claim_id, $old_score, $change)
    {
        $item_type = 3;//ad 
...
/**
     ...
     * @param int $change
     */
    public static function delete_question($uid, $qid, $old_score, $change)
    {
        $item_type = 1;//question 
        $claim_id = 0;
     ...
     * @param int $change
     */
    public static function delete_answer($uid, $aid, $old_score, $change)
    {
        $item_type = 2;//answer 
        $claim_id = 0;
...
/**
     ...
     * @param int $change
     */
    public static function vote_question($uid, $qid, $old_score, $change)
    {
        $item_type = 1;//question 
        $claim_id = 0;
     ...
     * @param int $change
     */
    public static function vote_answer($uid, $aid, $old_score, $change)
    {
        $item_type = 2;//answer 
        $claim_id = 0;
     ...
     * @param int $change
     */
    public static function extend_ad($uid, $ad_id, $old_score, $change)
    {
        $item_type = 3;//ad 
        $claim_id = 0;
