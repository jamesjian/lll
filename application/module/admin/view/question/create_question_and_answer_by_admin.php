...
<form action="<?php echo ADMIN_HTML_ROOT . 'question/create_by_admin'; ?>" method="post">
    <fieldset>
        ...
        <dl>
            ...
            <dt> Content: </dt><dd><textarea cols="10" rows="30" name="q_content"><?php if (isset($_POST['q_content'])) echo $_POST['q_content']; ?></textarea></dd>
            <dt> Answer: </dt><dd><textarea cols="10" rows="30" name="a_content"><?php if (isset($_POST['a_content'])) echo $_POST['a_content']; ?></textarea></dd>
            <dt> </dt>
