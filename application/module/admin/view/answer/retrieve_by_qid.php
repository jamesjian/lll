<?php
include 'search.php';
$create_link = ADMIN_HTML_ROOT . 'answer/create/' . $qid;
?>
<a href="<?php echo $create_link;?>">Create</a>
<?php
if ($answer_list) {
$link_prefix = ADMIN_HTML_ROOT . "answer/retrieve_by_qid/$qid/$current_page/";
...
<?php
$link_prefix = ADMIN_HTML_ROOT . 'answer/retrieve_by_qid/' . $qid;	
