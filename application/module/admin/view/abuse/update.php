<form action="<?php echo ADMIN_HTML_ROOT . 'abuse/update'; ?>" method="post">
    <fieldset>
        <legend>Update article</legend>
        <dl>
            <dt>Item ID</dt>
            <dd><a href=""><?php echo $abuse['item_id'];?></a></dd>
            <dt>Item Type</dt>
            <dd>
                <?php
                $item_types = array('1'=>'question', '2'=>'answer', '3'=>'ad');
                echo $item_types[$abuse['item_type']];
                ?>
            </dd>
            <dt>Content</dt>
            <dd>
                <?php
                if ($abuse['item_type'] == 2) {
                    //answer has no title
                    echo $item['content'];
                } else {
            ...
            <dt> <input type="hidden" name="id" value="<?php echo $abuse['id']; ?>" /></dt>
