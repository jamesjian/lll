...
class Question extends Base {
    ...
    /*     * one question
     * /front/question/content/id/slug-url
    ...
    public function content() {
        ...
        if ($question) {
            ...
            $answers = Model_Answer::get_active_answers_by_question_id($question_id);
    ...
    /**
     * front/question/keyword/$keyword/page/3, 3 is page number
     */
    public function keyword() {
        ...
        if ($keyword == '') {
            ...
            $order_by = 'rank';
            $direction = 'DESC';
            $questions = Model_Question::get_active_questions_by_keyword_and_page_num($keyword, $current_page, $order_by, $direction);
            //\Zx\Test\Test::object_log('$questions', $questions, __FILE__, __LINE__, __CLASS__, __METHOD__);
            $num_of_questions = Model_Question::get_num_of_active_questions_by_keyword($keyword);
    ...
    /**
      retrieve questions under a tag
      front/question/tag/id/page/3/保险第三页, 3 is page number
      $params[0] = id, $params[1] = 'page', $params[2] = 3, $params[3]=保险第三页;
     */
    public function tag() {
